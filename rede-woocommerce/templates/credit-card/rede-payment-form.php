...
<fieldset id="rede-credit-payment-form" class="rede-payment-form">
	<p class="form-row form-row-wide">
		<label for="rede-card-number"><?php esc_attr_e( 'Card Number', 'rede-woocommerce' ); ?><span
	...
	<?php if ( is_array( $installments ) && count( $installments ) > 1 ) : ?>
		<p class="form-row form-row-wide">
			<label for="installments"><?php esc_attr_e( 'Installments ', 'rede-woocommerce' ); ?><?php echo count( $installments ); ?><span
	...
	<?php endif; ?>
	<p class="form-row form-row-wide">
		<label for="rede-card-holder-name"><?php esc_attr_e( 'Name on Card', 'rede-woocommerce' ); ?><span
	...
	<p class="form-row form-row-first">
		<label for="rede-card-expiry"><?php esc_attr_e( 'Card Expiring Date', 'rede-woocommerce' ); ?><span
					class="required">*</span></label> <input id="rede-card-expiry"
															 name="rede_credit_expiry"
															 class="input-text wc-credit-card-form-card-expiry"
															 type="tel"
															 autocomplete="off"
															 placeholder="<?php esc_attr_e( 'MM / YEAR', 'rede-woocommerce' ); ?>"
															 style="font-size: 1.5em; padding: 8px;"/>
	</p>
	<p class="form-row form-row-last">
		<label for="rede-card-cvc">Código de segurança<span
					class="required">*</span></label> <input id="rede-card-cvc"
															 ...
															 autocomplete="off"
															 placeholder="<?php esc_attr_e( 'CVC', 'rede-woocommerce' ); ?>"
															 style="font-size: 1.5em; padding: 8px;"/>
	</p>
	<div class="clear"></div>
</fieldset>
