jQuery(function(t) {
    (function() {
        var e, n, r, a, i, o, l, u, s, c, h, p, f, g, v, d, m, y, C, T, w, $, D, S = [].slice,
        ...
        (t = window.jQuery || window.Zepto || window.$).payment = {}, t.payment.fn = {}, t.fn.payment = function() {
            ...
            for (t = (t + "").replace(/\D/g, ""), i = 0, l = r.length; i < l; i++)
                for (o = 0, u = (s = (e = r[i]).patterns).length; o < u; o++)
            ...
            var n, r, a;
            if ("/" === (a = String.fromCharCode(e.which)) || " " === a) return n = t(e.currentTarget), r = n.val(), /^\d$/.test(r) && "0" !== r ? n.val("0" + r + " / ") : void 0
        }, o = function(e) {
            var n, r;
            ...
            var n, r, a;
            if (n = t(e.currentTarget), r = String.fromCharCode(e.which), /^\d+$/.test(r) && !h(n)) return a = n.val() + r, !((a = a.replace(/\D/g, "")).length > 4) && void 0
        }, y = function(e) {
            var n, r;
            ...
            var e, n, r;
            return r = t.split(/[\s\/]+/, 2), e = r[0], 2 === (null != (n = r[1]) ? n.length : void 0) && /^\d+$/.test(n) && (n = (new Date).getFullYear().toString().slice(0, 2) + n), e = parseInt(e, 10), n = parseInt(n, 10), {
                month: e,
                year: n
            }
            ...
            var r, a, i;
            return "object" == typeof e && "month" in e && (e = (i = e).month, n = i.year), !(!e || !n) && (e = t.trim(e), n = t.trim(n), !!/^\d+$/.test(e) && (!!/^\d+$/.test(n) && (1 <= e && e <= 12 && (2 === n.length && (n = n < 70 ? "20" + n : "19" + n), 4 === n.length && (a = new Date(n, e), r = new Date, a.setMonth(a.getMonth() - 1), a.setMonth(a.getMonth() + 1, 1), a > r)))))
        }, t.payment.validateCardCVC = function(e, r) {
            var a, i;
            return e = t.trim(e), !!/^\d+$/.test(e) && (null != (a = n(r)) ? (i = e.length, k.call(a.cvcLength, i) >= 0) : e.length >= 3 && e.length <= 4)
            ...
            var e, n, r, a;
            return (n = t.match(/^\D*(\d{1,2})(\D+)?(\d{1,2})?/)) ? (e = n[1] || "", r = n[2] || "", (a = n[3] || "").length > 0 ? r = " / " : " /" === r ? (e = e.substring(0, 1), r = "") : 2 === e.length || r.length > 0 ? r = " / " : 1 === e.length && "0" !== e && "1" !== e && (e = "0" + e, r = " / "), e + r + a) : ""
        }
    }).call(this)
});